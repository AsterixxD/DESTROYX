    ...
    if ".mafk" not in current_message and "yes" in USER_AFK:  # pylint:disable=E0602
        ...
        try:
            await borg.send_message(  # pylint:disable=E0602
                Config.TAG_LOG,  # pylint:disable=E0602
...
async def on_afk(event):
    ...
    if "mafk" in current_message_text:
        # ub's should not reply to other ub's
...
CMD_HELP.update(
    {
        "mafk": ".mafk (reason) (link of any media) or reply to it "
